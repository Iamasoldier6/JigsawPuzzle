...
import com.iamasoldier6.jigsawpuzzle.adapter.GridItemsAdapter;
import com.iamasoldier6.jigsawpuzzle.bean.ItemBean;
import com.iamasoldier6.jigsawpuzzle.util.GameUtil;
import com.iamasoldier6.jigsawpuzzle.util.ImagesUtil;
...
public class PuzzleMain extends AppCompatActivity implements View.OnClickListener {
    ...
    private void handlerImage(Bitmap bitmap) {
        ...
        mPicSelected = new ImagesUtil().resizeBitmap(screenWidth * 0.8F,
                screenHeight * 0.6F, bitmap);
    }
